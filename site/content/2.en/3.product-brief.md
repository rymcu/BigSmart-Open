...
It is intended for Xiaozhi AI terminals, smart home controllers, portable media players, and handheld game prototypes. For pin assignments and hardware details, see [Hardware Configuration](/en/docs/hardware). For setup and operation, see the [User Manual](/en/docs/user-manual).
