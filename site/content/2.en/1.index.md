...
| English | 中文 |
|---------|------|
| [Quick Start Guide](/en/docs/quick-start) | [快速使用指南](/docs/quick-start) |
| [Product Brief](/en/docs/product-brief) | [产品介绍书](/docs/product-brief) |
| [User Manual](/en/docs/user-manual) | [用户详细使用手册](/docs/user-manual) |
| [Hardware Configuration](/en/docs/hardware) | [硬件配置说明](/docs/hardware) |
| [Video Converter User Guide](/en/docs/video-converter) | [视频转换器使用说明](/docs/video-converter) |
...
- [Firmware flashing guide](/en/docs/firmware)
