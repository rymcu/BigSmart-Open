...
- Before adding new peripherals, check [Hardware Configuration](/en/docs/hardware) to avoid GPIO conflicts.

## 16. References

- Project hardware documentation: [hardware.md](/en/docs/hardware)
