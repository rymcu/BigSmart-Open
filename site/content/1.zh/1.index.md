...
| 中文 | English |
|------|---------|
| [快速使用指南](/docs/quick-start) | [Quick Start Guide](/en/docs/quick-start) |
| [产品介绍书](/docs/product-brief) | [Product Brief](/en/docs/product-brief) |
| [用户详细使用手册](/docs/user-manual) | [User Manual](/en/docs/user-manual) |
| [硬件配置说明](/docs/hardware) | [Hardware Configuration](/en/docs/hardware) |
| [视频转换器使用说明](/docs/video-converter) | [Video Converter User Guide](/en/docs/video-converter) |
